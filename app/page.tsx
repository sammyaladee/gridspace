...
export default function HomePage() {
  return (
    <section>
      {/* Hero */}
      <div className="bg-gradient-to-b from-[#6a362b] to-[#2a2c3e] text-white h-[450px] flex flex-col items-center justify-center text-center">
      ...
      {/* Cards */}
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-6 py-16 px-6">
        <Card
          title="Cowork Spaces"
          description=""
